package top.yumbo.ai.reviewer.adapter.parser.detector;

import lombok.extern.slf4j.Slf4j;
import top.yumbo.ai.reviewer.adapter.parser.detector.language.CppLanguageDetector;
import top.yumbo.ai.reviewer.adapter.parser.detector.language.GoLanguageDetector;
import top.yumbo.ai.reviewer.adapter.parser.detector.language.RustLanguageDetector;
