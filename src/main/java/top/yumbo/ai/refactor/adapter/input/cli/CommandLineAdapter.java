package top.yumbo.ai.refactor.adapter.input.cli;
...
import top.yumbo.ai.refactor.application.port.input.ProjectAnalysisUseCase;
...
import top.yumbo.ai.refactor.application.service.ReportGenerationService;
...
public class CommandLineAdapter {
    ...
    private void printUsage() {
        ...
        System.out.println("\n用法: java -jar ai-reviewer-refactor.jar [选项]");
        System.out.println("\n选项:");
        ...
        System.out.println("\n示例:");
        System.out.println("  java -jar ai-reviewer-refactor.jar --project /path/to/project");
        System.out.println("  java -jar ai-reviewer-refactor.jar -p . -o report.md -f markdown");
        System.out.println("  java -jar ai-reviewer-refactor.jar -p /project -a -o report.html -f html");
    }
